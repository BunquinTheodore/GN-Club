...
export function ServiceDetailPanels({ slug }: ServiceDetailPanelsProps) {
  ...
  return (
    <HorizontalScroll>
      {/* Backdrop hero — mirrors CaseStudyPanels' intro section: full-bleed
          duotone photo, scrim, back-link, and the title stack on top. */}
      <section className="relative px-6 pt-20 pb-16 sm:pt-24 sm:pb-20 md:pt-16 lg:px-10">
        ...
        <div className="relative mx-auto w-full max-w-6xl">
          ...
          {/* Capabilities — the service's real catalog items, from
              lib/services.ts's existing `items` array. */}
          ...
          {service.overview && service.overview.length > 0 && (
            <PanelReveal delay={0.08} className="mt-14">
