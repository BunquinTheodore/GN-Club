    ...
    process: [
      {
        ...
        description: "We define whether the session is fully virtual, pre-recorded, or hybrid, and which platforms it needs to reach.",
      },
      {
      ...
      },
      {
        ...
        description: "Recordings get pulled, edited, and handed back on the agreed turnaround for re-use or archiving.",
      },
    ],
